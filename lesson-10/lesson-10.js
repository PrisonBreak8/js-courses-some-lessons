...
//	// Даные для выполнения функции: cart=johnCart и для коллбэк функции finalPrice=price
...
//		}
//		// в коллбэк функцию передан параметр finalPrice который мы получили в итоге расчетов этот параметр будет передан и использован в другом месте
//		callback(finalPrice);
//	}, 1000);
//}
